...
export default function Editgallery({ gallery }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('gallery.update', gallery.id));  // Send the PUT request to update the gallery
    };
            ...
            <div className="flex justify-center items-center pt-5 md:pt-5 lg:pt-5">
                <div className="bg-white shadow-md p-10 rounded-lg w-full max-w-3xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-7">
                            <label htmlFor="date" className="block mb-1 font-medium text-gray-700 text-sm">gallery Date</label>
                            <input
                                type="date"
                                id="date"
                                name="date"
                        ...
                        <div className="mb-7">
                            <label htmlFor="photo" className="block mb-1 font-medium text-gray-700 text-sm">gallery Photo</label>
                            <div className="border-2 border-gray-300 p-4 hover:border-blue-500 border-dashed rounded-md text-center transition duration-300 cursor-pointer">
                                ...
                                <label htmlFor="photo" className="text-gray-500 hover:text-blue-500 cursor-pointer">
                                    {data.photo ? data.photo.name : "Upload gallery Photo"}
                                </label>
                            </div>
