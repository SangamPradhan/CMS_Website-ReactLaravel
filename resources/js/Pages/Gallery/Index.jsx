...
export default function TestimonialIndex({ testimonials }) {
    ...
    // Filter testimonials by name based on the search term
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-gray-800 text-xl leading-tight">Testimonials</h2>}
        >
                                    ...
                                    <tbody>
                                        {filteredTestimonials.map(testimonial => (
                                            <tr key={testimonial.id}>
                                                ...
                                                <td className="px-4 py-2 border">{testimonial.testimonial}</td>
