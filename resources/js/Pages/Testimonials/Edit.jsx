...
export default function Edit({ testimonial }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('testimonials.update', testimonial.id));  // Send the PUT request to update the testimonial
    };
            ...
            <div className="flex justify-center items-center pt-5 md:pt-5 lg:pt-5">
                <div className="bg-white shadow-md p-10 rounded-lg w-full max-w-3xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-7">
                            <label htmlFor="rating" className="block mb-1 font-medium text-gray-700 text-sm"> Ratings</label>
                            <textarea
                                id="rating"
                                name="rating"
                                value={data?.rating}
