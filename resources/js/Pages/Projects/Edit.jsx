        ...
        <AuthenticatedLayout
            header={
                <div className="flex justify-between items-center">
                    ...
                    <Link href={route('projects.index')} className="bg-red-600 hover:bg-gray-700 px-4 py-2 rounded-md text-white focus:outline-none">
                        Cancel
                    </Link>
                </div>
            }
        ...
        >
            ...
            <div className="flex justify-center items-center pt-5 md:pt-5 lg:pt-5">
                <div className="bg-white shadow-md p-10 rounded-lg w-full max-w-3xl">
                    <h2 className="mb-10 font-bold text-2xl text-blue-500">Update project Information</h2>
